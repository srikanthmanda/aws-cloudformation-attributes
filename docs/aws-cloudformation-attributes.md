...
- - -
This document was generated from [AWS CloudFormation User Guide](https://github.com/awsdocs/aws-cloudformation-user-guide) using [`aws-cloudformation-attributes`](https://github.com/srikanthmanda/aws-cloudformation-attributes).